...
void main()
{
	setlocale(LC_ALL, "");
#ifdef STL_ARRAY
	//array - ýòî êîíòåéíåð, êîòîðûé äëÿ õðàíåíèÿ äàííûõ èñïîëüçóåò ñòàòè÷åñêèé ìàññèâ.
	const int N = 5;
	/*int arr[N] = { 3,5,8 };
	for (int i = 0; i < N; i++)
	{
...
#ifdef STL_DEQUE
	//deque - ýòî êîíòåéíåð, êîòîðûé ïðåäñòàâëÿåò ñîáîé ñïèñîê äèíàìè÷åñêèõ ìàññèâîâ
	//(ñïèñîê âåêòîðîâ).
